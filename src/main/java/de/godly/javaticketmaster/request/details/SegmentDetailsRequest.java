...
public class SegmentDetailsRequest extends DiscoveryRequest {
    ...
    public SegmentDetailsResponse request() throws IOException {
        ...
        StringBuilder builder = new StringBuilder("https://app.ticketmaster.com/discovery/v2/classifications/segments/" + parameters.get(SegmentDetailsRequestParameter.ID) + ".json"+ "?apikey=" +  getJavaTicketMaster().getApiKey());
